...
function setColorScheme(scheme) {
    switch (scheme) {
        case 'dark':
            ...
            document.documentElement.style.setProperty('--background-primary-color-RGBA', 'rgba(0, 0, 0, 0.3)');
        ...
        case 'light':
            ...
            document.documentElement.style.setProperty('--background-primary-color-RGBA', 'rgba(255, 255, 255, 0.3)');
